...
{   
    ...
    // cout<<"flag_can_get_aim:"<<flag_can_get_aim<<endl;
     ...
     if(flag_can_start_detect.data > 0.50)   
    // if(flag_can_get_aim)
...
void  cur_z_pos_cb(const geometry_msgs::PoseStamped::ConstPtr& msg)
{
    ...
    if(flag_start == 1)
    {
        ...
        if(z_hold_time > 50)
        {
            z.set_aimpose(z.read_beginpose() + z_second_aim);
        }
    }
    ...
    {   
        ...
        {   
            ...
            {     
                 ...
                 {
                    flag_can_start_detect.data = 0.0;           //这时必定已经接收到目标点信息，修改检测为0.0,false
            ...
            cout << "flag_can_start_detect.data" << flag_can_start_detect.data << endl;
...
int main(int argc, char **argv)
{
   ...
   while(ros::ok() && !current_state.connected)
    ...
    while(ros::ok())
    {
        ...
        //遥控器切回去之后，节点不会再次发送切换为offboard的控制信号
