...
int hold_time = 0;
int z_hold_time = 0;
int flag_can_get_aimpose = 0;
int flag_get_aimpose = 0;
...
bool is_back_home(xdd::get_aim::Request &req, xdd::get_aim::Response &res)
{
    ...
    {   
        ...
        cout<<endl;
        res.is_back_home = 1;
        // cout<<"回到起点:"<<res.is_back_home<<endl;
        flag_can_get_aimpose = 0;
        return true;
    }
    return false; 
}
...
{   
    ...
    // cout<<"flag_can_get_aimpose:"<<flag_can_get_aimpose<<endl;
